...
<nav class="navbar navbar-expand-lg ">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link " style="margin-right: -10px;">Your Cart <input id="cartvalue" class="cart-value" type="number" value="0" min="0" max="20" disabled></a>
      </li>
...
<div class="col-md-4">
    ...
    <div class="star">
        ...
        <div class="Add-Cart">
        <button href="#" class="cart" onclick="subtract()"><i class="far fa-minus-square"></i></button>
        <button href="#" class="cart" onclick="add()">Add to Cart <i class="fas fa-cart-plus"></i></button>
        </div>
</div>
</div>
...
<script>
    ...
    function add() {
  if(document.getElementById("cartvalue").value ==20)
  {
...
function subtract() {
  ...
  if(x>0)
  {
    document.getElementById("cartvalue").stepDown(1);
  }
}
